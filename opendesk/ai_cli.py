...
def parse_ask(prompt: str):
    ...
    tool_map = {
        ...
        ("processes", "running processes", "top processes"): ("list_processes", {"limit": 10, "sort_by": "memory"}),
        ("files", "directory", "folder", "list files", "show files"): ("list_directory", {"path": "~", "max_items": 10}),
